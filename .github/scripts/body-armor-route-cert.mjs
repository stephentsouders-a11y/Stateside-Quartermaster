...
const ROUTES=[
 ['morale-patches-tactical-id','Morale Patches'],
 ['outdoor-preparedness-gear','Outdoor'],
 ['patriotic-american-heritage','Patriotic'],
 ['safety-rescue-climbing','Safety Rescue'],
 ['sta-brite-insignia','Sta-Brite'],
